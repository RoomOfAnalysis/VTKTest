...
namespace
{
    ...
    vtkSmartPointer<vtkVolume> GetVolume(vtkSmartPointer<vtkImageData> imgData, VolumeType type, float sample_distance,
                                         float img_sample_distance, double iso1, double iso2, double color1[3],
                                         double color2[3])
    {
        ...
        colorTransferFunction->AddRGBPoint(iso2, color1[0], color1[1], color1[2]);
        colorTransferFunction->AddRGBPoint(iso1, color2[0], color2[1], color2[2]);
    ...
    vtkSmartPointer<vtkPropCollection> SetupMyActorsForRayCast(std::string const& imgDataName,
                                                               vtkSmartPointer<vtkImageData> imgData, VolumeType type,
                                                               float sample_distance, float img_sample_distance,
                                                               double iso1, double iso2, double color1[3],
                                                               double color2[3])
    {
        // volume
